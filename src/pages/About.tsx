          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  বইআলো.কম ২০২২ সালে যাত্রা শুরু করে একটি ছোট বইয়ের দোকান হিসেবে। আমাদের লক্ষ্য ছিল মানসম্মত ইসলামিক ও শিক্ষামূলক বই সবার কাছে পৌঁছে দেওয়া।
                </p>
                <p>
                  আজ আমরা বাংলাদেশের অন্যতম বৃহত্তম অনলাইন বুকশপ, যেখানে ৫০০+ বই এবং ৮০+ প্রকাশনীর সংগ্রহ রয়েছে।
                </p>
                <p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  ১৪১,১/বি, দক্ষিন পীরেরবাগ, মিরপুর,ঢাকা-১২১৬, বাংলাদেশ
                </p>
