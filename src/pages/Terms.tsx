            ...
            <div className="bg-card rounded-xl p-6 md:p-8 shadow-sm space-y-6">
              <section>
                ...
                <p className="text-muted-foreground">
                  আমাদের ওয়েবসাইটে প্রবেশ করে বা এর সেবা ব্যবহার করে আপনি এই শর্তাবলী মেনে নিচ্ছেন। এই শর্তাবলী সময়ে সময়ে পরিবর্তিত হতে পারে এবং পরিবর্তনগুলো ওয়েবসাইটে প্রকাশের সাথে সাথে কার্যকর হবে।
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground">
                  এই ওয়েবসাইটের সকল কন্টেন্ট, লোগো, ছবি এবং ডিজাইন বইআলো এর সম্পত্তি এবং কপিরাইট আইন দ্বারা সুরক্ষিত। অনুমতি ছাড়া কোনো কন্টেন্ট ব্যবহার নিষিদ্ধ।
                </p>
              </section>
