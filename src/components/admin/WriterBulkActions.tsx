...
export const WriterBulkActions = ({ onImportComplete }: WriterBulkActionsProps) => {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      downloadXLSX(CSV_HEADERS, rows, `writers_export_${new Date().toISOString().split('T')[0]}.xlsx`);
  ...
  const handleDownloadTemplate = () => {
    downloadXLSX(
      ...
      [[
        ...
        'Humayun Ahmed',
        'humayun-ahmed',
        'বাংলাদেশের জনপ্রিয় লেখক',
        'Popular Bangladeshi author',
        'TRUE',
        'হুমায়ূন আহমেদ - লেখক',
        'বাংলাদেশের সবচেয়ে জনপ্রিয় লেখক',
      ]],
      'writers_import_template.xlsx'
    );
